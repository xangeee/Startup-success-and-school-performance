...
conn_fz = duckdb.connect("../DB/DB_ExplotationZone",read_only=False)
conn_tz = duckdb.connect("../DB/DB_FeatureGeneration",read_only=False)
...
for t in existingTables:
    ...
    #saving the data
    name = t[0].split("$")[0]
    if name == "startups_studentsPerformance":
      print(name)
